...
ggplot() +
  ...
  annotate("text", x = 0, y = 0, label = "The Kuhn Cycle", fontface = 2, size = 10) +
  ...
  annotate("label", hjust = "right", x = 5.6, y = 2.825, fontface = 2, color = "#B12A90FF", 
           label = "Your science / this book is about", size = 3.25,
           fill = "white") +
  ## upper left
  ...
  annotate("text", x = 0, y = 2.1, label = "Puzzle and problem solving", 
           fontface = 3, size = 3.5) +
  annotate("text", x = 0, y = 1.8, label = "Fit nature in the box of knowing", 
           fontface = 3, size = 3.5) +
  ...
  annotate("text", x = 4.25, y = 0.1, label = "Encounter anomalies", 
           fontface = 3, size = 3.5) +
  annotate("text", x = 4.25, y = -0.2, label = "Experimental error", 
           fontface = 3, size = 3.5) +
  annotate("text", x = 4.25, y = -0.5, label = "Anomalies pile up", 
           fontface = 3, size = 3.5) +
  ...
  annotate("text", x = 1.75, y = -1.9, label = "Theory breaking point", 
           fontface = 3, size = 3.5) +
  annotate("text", x = 1.75, y = -2.2, label = "Anomalies are significant", 
           fontface = 3, size = 3.5) +
  annotate("text", x = 1.75, y = -2.5, label = "Tension and frustration", 
           fontface = 3, size = 3.5) +
  ...
  annotate("text", x = -1.75, y = -1.9, label = "New candidate of reality", 
           fontface = 3, size = 3.5) +
  annotate("text", x = -1.75, y = -2.2, label = "New tools and theories", 
           fontface = 3, size = 3.5) +
  annotate("text", x = -1.75, y = -2.5, label = "Mostly young scientists", 
           fontface = 3, size = 3.5) +
  ...
  annotate("text", x = -4.25, y = 0.1, label = "New paradigm of reality", 
           fontface = 3, size = 3.5) +
  annotate("text", x = -4.25, y = -0.2, label = "New language usage", 
           fontface = 3, size = 3.5) +
  annotate("text", x = -4.25, y = -0.5, label = "New box of knowing", 
           fontface = 3, size = 3.5) +
