...
p_observed <- ggplot() +
  ...
  annotate("text", x = 0.6, y = 1, hjust = "left", label = "Sun", size = 4) +
  annotate("point", x = -8.6, y = -5, size = 4) +
  annotate("text", x = -8.3, y = -4.5, hjust = "left", label = "Mercury", size = 4) +
...
p_model <- ggplot() +
  ...
  annotate("text", x = -8.8, y = -4.5, hjust = "left", label = "Mercury", size = 4) +
...
p_observed <- 
  ...
  geom_curve(aes(x = -4.5, y = -3, xend = 5.75, yend = 1.5),
             ...
             color = "gray50", size = 2, curvature = 0.2,
  ) +
...
p_model <- ggplot() +
  ...
  geom_curve(aes(x = -0.25, y = -0.5, xend = -4.5, yend = -3.5),
             arrow = arrow(length = unit(0.3, "cm"), type = "closed"),
             color = "gray50", size = 2, curvature = -0.3,
  ) +
  annotate("label", x = -2, y = -3, hjust = "center", label = "Cloud gaps", size = 4,
           color = "black") + 
  geom_curve(aes(x = 0.25, y = -0.5, xend = 5.75, yend = 1.5),
             arrow = arrow(length = unit(0.3, "cm"), type = "closed"),
             color = "gray50", size = 2, curvature = 0.3,
  ) +
  annotate("label", x = 3, y = -1.5, hjust = "center", label = "Cloud gaps", size = 4,
           color = "black") + 
  labs(title = "Model") +
