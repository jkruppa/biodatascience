...
ggplot() +
  theme_void() +
  theme_minimal() +
  coord_cartesian(xlim = c(-5, 5), ylim = c(-9, 0)) +
  ...
  annotate("text", x = 0, y = -0.5, label = "Theory", fontface = 2, size = 5) +
  geom_curve(aes(x = 3.1, y = -1.5, xend = 4, yend = -3.8),
             arrow = arrow(length = unit(0.2, "cm"), type = "closed"),
             color = "gray50", size = 1.25, curvature = -0.35) +
  annotate("text", angle = 50, x = -4, y = -2, label = "suggest", fontface = 2, size = 4) +
  geom_curve(aes(x = -3.1, y = -1.5, xend = -4, yend = -3.8),
             arrow = arrow(length = unit(0.2, "cm"), type = "closed"),
             color = "gray50", size = 1.25, curvature = 0.35) +
  annotate("text", angle = -50, x = 4, y = -2, label = "blueprint", fontface = 2, size = 4) +
  ## left
  geom_shape(data = tibble(x = c(-5, -1, -1, -5), 
                           y = c(-4, -4, -9, -9)),
             aes(x, y), radius = unit(0.1, 'cm'), 
             fill = "gray95", color = "gray50") +
  annotate("text", x = -3, y = -4.5, label = "Experimental", fontface = 2, size = 5) +
  ## right
  geom_shape(data = tibble(x = c(5, 1, 1, 5), 
                           y = c(-4, -4, -9, -9)),
             aes(x, y), radius = unit(0.1, 'cm'), 
             fill = "gray95", color = "gray50") +
  annotate("text", x = 3, y = -4.5, label = "Instrumental", fontface = 2, size = 5) +
  ## arrows
  geom_curve(aes(x = -0.9, y = -6, xend = 0.9, yend = -6),
             arrow = arrow(length = unit(0.2, "cm"), type = "closed"),
             color = "gray50", size = 1.25, curvature = 0) +
  annotate("text", x = 0, y = -5.5, label = "needed", fontface = 2, size = 4) +
  geom_curve(aes(x = 0.9, y = -7, xend = -0.9, yend = -7),
             arrow = arrow(length = unit(0.2, "cm"), type = "closed"),
             color = "gray50", size = 1.25, curvature = 0) +
  annotate("text", x = 0, y = -7.5, label = "measured", fontface = 2, size = 4) 
```
