...
ggplot() +
  theme_void() +
  ##theme_minimal() +
  coord_cartesian(xlim = c(0.5, 10.5), ylim = c(0.5, -9.5)) +
  ...
  annotate("text", x = 2.25, y = -1, label = "Decision making using inference", 
  ...
  annotate("text", x = 2.25, y = -2.9, label = "Statistical modeling", 
           size = 4.5, fontface = 2, hjust = "left", color = "black") + 
  annotate("text", x = 2.25, y = -3.5, label = "Mathematical tool to find a pattern in", 
           size = 4.25, fontface = 3, hjust = "left", color = "black") + 
  annotate("text", x = 2.25, y = -4.1, label = "the data by minimizing the noise/error.", 
           size = 4.25, fontface = 3, hjust = "left", color = "black") + 
  annotate("text", x = 2.25, y = -5, label = "Finds the most likly parameter for a line", 
           size = 4.25, fontface = 3, hjust = "left", color = "black") + 
  annotate("text", x = 2.25, y = -5.6, label = "through points.", 
           size = 4.25, fontface = 3, hjust = "left", color = "black") + 
  ##
  geom_shape(data = tibble(x = c(2, 10.5, 10.5, 2), 
                           y = c(-8, -8, -6.5, -6.5)),
  ...
  annotate("text", x = 0.5, y = -4, angle = 90,
           label = "PROBALISTIC - Frequentist / Bayesian", size = 4.75, fontface = 2, 
           color = "#6A00A8FF")
``` 
