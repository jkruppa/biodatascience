...
Can sciene be objective? "Science is in reality a classification and analysis of the contents of the mind. […] In truth, the field of science is much more consciousness than an external world."
...
p_wall <- ggplot() +
  ...
  annotate("text", x = c(1.75, 8.25), y = 6.5, size = 4, color = "#6A00A8FF",
...
ggplot() +
  ...
  annotate("text", x = 0, y = c(0.65, 0, -0.65)+0.25, 
  ...
  annotate("text", x = 0, y = 4.35, label = "SCIENCE", angle = 0, size = 12.5,
           fontface = 2) +
  annotate("text", x = 0, y = 2, label = "The why", size = 10,
  ...
  annotate("text", x = 3.75, y = -2.25, label = "MODEL", angle = 60, size = 12.5,
           fontface = 2) +
  annotate("text", x = 1.5, y = -0.75, label = "The how", angle = 60, size = 10,
  ...
  annotate("text", x = -3.75, y = -2.25, label = "DATA", angle = -60, size = 12.5,
           fontface = 2) +
  annotate("text", x = -1.5, y = -0.75, label = "The what", angle = -60, size = 10,
