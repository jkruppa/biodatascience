...
ggplot() +
  theme_void() +
  ## theme_minimal() +
  coord_cartesian(xlim = c(0.5, 10), ylim = c(0, 6.5)) +
  ...
  annotate("segment", x = 2, xend = 10, y = 5, yend = 0.1, size = 2.5, color = "#0D0887FF",
           lineend = "round") +
  annotate("text", x = 5.5, y = 3.25, label = "d = 0.6m", fontface = 2, size = 7, color = "#0D0887FF",
           angle = -30) +
  ...
  annotate("text", x = 0.75, y = 2.45, label = "h", fontface = 2, size = 7, color = "#FCA636FF") +
  annotate("text", x = 4.5, y = 1.5, label = expression(phantom(x) %up% bold(h) %down% bold(Delta*t)), fontface = 2, size = 8, 
           color = "black") +
