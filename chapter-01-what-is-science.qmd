...
ggplot() +
  ...
  annotate("text", x = 0, y = 4, label = "Science", angle = 0, size = 5) +
  annotate("text", x = 3.5, y = -2, label = "Model", angle = 60, size = 5) +
  annotate("text", x = -3.5, y = -2, label = "Data", angle = -60, size = 5) +
  ## lower
