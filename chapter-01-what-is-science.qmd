...
ggplot() +
  theme_void() +
  ## theme_minimal() +
  coord_cartesian(xlim = c(-5, 5), ylim = c(-4.25, 4.75)) +
  ...
  geom_circle(aes(x0 = 0, y0 = 0, r = 4), size = 0.75, color = "gray50") +
  annotate("text", x = 0, y = 0, label = "Choose\nat least\ntwo!",
           fontface = 2 , size = 12.5) +
  annotate("point", x = c(0, 3.5, -3.5), y = c(4, -2, -2), size = 4) +
  annotate("text", x = 0, y = 4.35, label = "SCIENCE", angle = 0, size = 12.5,
           fontface = 2) +
  annotate("text", x = 0, y = 4.9, label = "What is the theory?", angle = 0, 
           size = 10, fontface = 3) +
  annotate("text", x = 3.75, y = -2.25, label = "MODEL", angle = 60, size = 12.5,
           fontface = 2) +
  annotate("text", x = 4.25, y = -2.5, label = "What is the pattern?", angle = 60, 
           size = 10, fontface = 3) +
  annotate("text", x = -3.75, y = -2.25, label = "DATA", angle = -60, size = 12.5,
           fontface = 2) +
  annotate("text", x = -4.25, y = -2.5, label = "What is observed?", angle = -60, 
           size = 10, fontface = 3) +
  ## lower
  ...
  annotate("text", hjust = "center", x = 0, y = -3.3, fontface = 2, size = 7,
           label = "Data + Model") +
  annotate("text", hjust = "left", x = -1.8, y = -3.8, fontface = 2, size = 5.25,
           label = "Theories guided by observation") +
  annotate("text", hjust = "left", x = -1.8, y = -4.2, fontface = 3, size = 5.25,
           label = "bar bara bar bar") +
  ## right
  geom_shape(data = tibble(x = c(-2, 2, 2, -2), 
                           y = c(-4.5, -4.5, -3, -3)+7.5,
  ...
  annotate("text", hjust = "left", x = 2.3, y = 3.5, fontface = 2, size = 5.25,
           label = "Thought experiments find pattern", angle = -60) +
  annotate("text", hjust = "left", x = 1.95, y = 3.25, fontface = 3, size = 5.25,
  ...
  annotate("text", hjust = "left", x = -2.3-1.9, y = 3.5-3.2, fontface = 2, size = 5.25,
           label = "Theories guided by observation", angle = 60) +
  annotate("text", hjust = "left", x = -1.95-1.9, y = 3.25-3.2, fontface = 3, 
           size = 5.25,
           label = "bar bara bar bar", angle = 60) 
```
