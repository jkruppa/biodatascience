...
#| fig-height: 9
#| fig-width: 10.5
#| fig-cap: "vaaa. Standard quantum mechanics refers to the Copenhagen interpretation of quantum mechanics."
...
ggplot() +
  ...
  annotate("text", hjust = "left", x = -1.8, y = -4.2, fontface = 3, size = 5.25,
           label = "Standard quantum mechanics") +
  ## right
  geom_shape(data = tibble(x = c(-2, 2, 2, -2), 
                           y = c(-4.5, -4.5, -3, -3)+7.5,
  ...
  annotate("text", hjust = "left", x = -1.95-1.9, y = 3.25-3.2, fontface = 3, 
           size = 5.25,
           label = "Story telling and visualisation on data", angle = 60) 
```
