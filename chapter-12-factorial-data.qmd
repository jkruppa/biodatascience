...
jump_flea_tbl |> 
  ggplot(aes(x = host, y = jump_length_cm, fill = host)) +
  theme_book() +
...
```{r}
tibble(jump_length_cm = rnorm(7, 5, 1),
...
jump_habitat_tbl |> 
  ggplot(aes(x = host, y = jump_length_cm, fill = site)) +
  theme_book() +
