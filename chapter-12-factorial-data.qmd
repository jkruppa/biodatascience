...
ggplot() +
  ...
  annotate("text", x = 11.5, y = -0.75, label = "VISUALISATION", size = 5, fontface = 2, 
           angle = -90) +
  ### barplots
  geom_rect(aes(xmin = 7.5, xmax = 8.5, ymin = -3, ymax = 0), fill = "#B12A9080",
            color = "black") +
  geom_rect(aes(xmin = 9.5, xmax = 10.5, ymin = -3, ymax = -1), fill = "#B12A9080",
            color = "black") +
  geom_segment(aes(x = 8, xend = 8, y = 0, yend = 1.2)) +
  geom_segment(aes(x = 10, xend = 10, y = -1, yend = 0)) +
  geom_segment(aes(x = 7.9, xend = 8.1, y = 1.2, yend = 1.2)) +
  geom_segment(aes(x = 9.9, xend = 10.1, y = 0, yend = 0)) +
  ### boxplots
  geom_rect(aes(xmin = 3.5, xmax = 4.5, ymin = -0.75, ymax = 0.75), fill = "#FCA63680",
            color = "black") +
  geom_rect(aes(xmin = 5.5, xmax = 6.5, ymin = -1.75, ymax = -0.25), fill = "#FCA63680",
            color = "black") +
  geom_segment(aes(x = 3.5, xend = 4.5, y = -0.25, yend = -0.25)) +
  geom_segment(aes(x = 5.5, xend = 6.5, y = -1, yend = -1)) +
  geom_segment(aes(x = 4, xend = 4, y = 0.75, yend = 1.2)) +
  geom_segment(aes(x = 4, xend = 4, y = -0.75, yend = -1.2)) +
  geom_segment(aes(x = 6, xend = 6, y = -0.25, yend = 0.2)) +
  geom_segment(aes(x = 6, xend = 6, y = -1.75, yend = -2.2)) +
  ### coords
...
#  geom_hline(yintercept = c(-5, 0, 5), color = "gray75") +
 # geom_vline(xintercept = c(-5, 0, 5), color = "gray75") +
  ...
  annotate("text", x = c(8), y = c(7.5, 6.75, 5.5, 4.5), 
