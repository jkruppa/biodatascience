...
ggplot() +
  ...
  annotate("text", x = 11.5, y = -0.75, label = "VISUALISATION", size = 5, fontface = 2, 
           angle = -90) +
  ### barplots
  geom_rect(aes(xmin = 7.5, xmax = 8.5, ymin = -3, ymax = 0), fill = "gray75",
            color = "black") +
  geom_rect(aes(xmin = 9.5, xmax = 10.5, ymin = -3, ymax = -1), fill = "gray75",
            color = "black") +
  ...
  ### boxplots
  geom_rect(aes(xmin = 3.5, xmax = 4.5, ymin = -0.75, ymax = 0.75), fill = "gray75",
            color = "black") +
  geom_rect(aes(xmin = 5.5, xmax = 6.5, ymin = -1.75, ymax = -0.25), fill = "gray75",
            color = "black") +
