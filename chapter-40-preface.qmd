...
ggplot() +
  ...
  annotate("segment", x = c(2, 8, 14), xend = c(2, 8, 14),
           y = c(0, 0, 0), yend = c(25.75, 25.75, 25.75)) +
  annotate("segment", x = c(0.25, 0.25, 0.25, 0.25), xend = c(20, 20, 20, 20),
           y = c(6, 12, 18, 24), yend = c(6, 12, 18, 24)) +
...
annotate("point", x = c(0.45, 0.7, 1.1, 1.25, 1.65, 1.87, 2.15, 2.5, 2.7, 3.2) + 3.5, 
  ...
  annotate("rect", xmin = 17.5, xmax = 19, ymin = 7.5, ymax = 9.15, fill = "#A21D9A80", color = "black") +
  annotate("rect", xmin = 17.5, xmax = 19, ymin = 9.15, ymax = 9.75, fill = "#B42E8D80", color = "black") +
