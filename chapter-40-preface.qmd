...
ggplot() +
  ...
  annotate("text", x = 1.5, y = c(3, 9, 15, 21), 
           label = c("Y is yes/no", "Y has discrete grades", "Y has counts", "Y is continuous"), 
...
annotate("point", x = c(0.45, 0.7, 1.1, 1.25, 1.65, 1.87, 2.15, 2.5, 2.7, 3.2) + 3.5, 
  ...
  ### 3lvl 
  annotate("rect", xmin = 10, xmax = 11, ymin = 7.5, ymax = 8.5, fill = "gray80", color = "black") +
  ...
  annotate("rect", xmin = 11, xmax = 12, ymin = 7.5, ymax = 9.15, fill = "gray80", color = "black") +
  ...
  annotate("rect", xmin = 12, xmax = 13, ymin = 7.5, ymax = 8.15, fill = "gray80", color = "black") +
  ...
  ### 2lvl
  annotate("rect", xmin = 16, xmax = 17.5, ymin = 7.5, ymax = 8.5, fill = "gray80", color = "black") +
  ...
  annotate("rect", xmin = 17.5, xmax = 19, ymin = 7.5, ymax = 9.15, fill = "gray80", color = "black") +
...
## binomial
  ...
  geom_curve(aes(x = 5.5, y = 3.25, xend = 7, yend = 4.5),
             curvature = -0.4, color = "black", linewidth = 0.65) +
  annotate("rect", xmin = 10, xmax = 11, ymin = 1.5, ymax = 3.5, fill = "gray80", color = "black") +
  annotate("rect", xmin = 10, xmax = 11, ymin = 3.5, ymax = 5, fill = "gray80", color = "black") +
  annotate("rect", xmin = 11, xmax = 12, ymin = 1.5, ymax = 3, fill = "gray80", color = "black") +
  annotate("rect", xmin = 11, xmax = 12, ymin = 3, ymax = 5, fill = "gray80", color = "black") +
  annotate("rect", xmin = 12, xmax = 13, ymin = 1.5, ymax = 2, fill = "gray80", color = "black") +
  annotate("rect", xmin = 12, xmax = 13, ymin = 2, ymax = 5, fill = "gray80", color = "black") +  
  ## 2lvl
  annotate("rect", xmin = 16, xmax = 17.5, ymin = 1.5, ymax = 3.5, fill = "gray80", color = "black") +
  annotate("rect", xmin = 16, xmax = 17.5, ymin = 3.5, ymax = 5, fill = "gray80", color = "black") +
  annotate("rect", xmin = 17.5, xmax = 19, ymin = 1.5, ymax = 3, fill = "gray80", color = "black") +
  annotate("rect", xmin = 17.5, xmax = 19, ymin = 3, ymax = 5, fill = "gray80", color = "black") 
