...
I would like to start with a general example. Perhaps you would like to see a more concrete example of a model. But first, I will show you the most general form of a statistical model. The model is simple and contains only two terms combined with a tilde. On the left-hand side (*LHS*) we find the outcome. The result of the experiment is the measured value. Sometimes, using these words can cause people confusion, but for now we'll stick to the idea that the result of something is measured in an experiment. On the right side (*RHS*), you will find the influencer. The influencer is the thing we are trying to change in the experiment. If you change the influencer, the statistical model will show you the change in the outcome.
