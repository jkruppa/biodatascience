...
Can we trust the data we are working with? Is the data valid, and what can we do with it? This also depends on the information buried in the data. If we can find information in our data, we can make decisions or predictions. However, these decisions and predictions will only be useful for future eventualities if the data from the past is connected to the future.
