...
This book requires a very specific type of observation. We need data. Data is a type of observation that is stored in a specific way. Not every observation can be used for a data sheet or table. As the names suggest, data is two-dimensional. A sheet is a type of paper on which we can write down organized observations. The same is true for a table. It is a structured type of observation.
