...
A lot could be written about experimental and observed data. The wording might be a little confusing because experimental data consists of observations that are clearly observed. Therefore, I prefer to refer to experimental data as data that comes from a controlled experiment. On the other hand, observed data is data that is generated without any influence from an experimenter. 
