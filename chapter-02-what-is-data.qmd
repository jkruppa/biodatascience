...
| Categorical $x$ | $A.1$ to $A.j$ | **levels**, groups, treatment groups | *The discrete groups included in one factor A.*  |
...
|  | Symbol | Name | Description |
|:-------------|:--------:|:------------------|:------------------|
|  | $y$ | **label**, response, endpoint, dependent variable | *The right-hand side (abbr. RHS) of the model. Describing the values measured in an experiment or study.* |
| Prediction | $x$ | **predictor**, predictive variable | *The influencer is used to predict the outcome.* |

: Table of terms used in the prediction. The terms in bold are used here. Depending on the scientific background, the usage of these terms can vary widely.  {#tbl-names-regression tbl-colwidths="$$20, 5, 30, 45$$"}
