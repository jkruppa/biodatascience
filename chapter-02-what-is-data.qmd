...
The data seems easy enough. We have a two-dimensional table with numbers and letters. That could be it. However, there are some things to consider. 
...
ggplot() +
  #theme_void() +
  theme_minimal() +
  coord_cartesian(xlim = c(0.75, 5.75), ylim = c(-0.75, 5.25)) +
  ...
  annotate("text", x = c(1, 2, 3, 4, 5), y = 4, 
           label = c("ID", "t", "t", "t", "Y"), fontface = 2, size = 6) +
  annotate("text", x = c(2, 3, 4, 5)+0.05, y = 3.75, hjust = "left",
           label = c("1", "2", "3", "combined"), fontface = 2) +
  annotate("text", x = 1, y = c(1, 2, 3), label = c(3:1), size = 6, fontface = 2) +
  annotate("point", x = c(2,3,4), y = c(1, 2, 3), shape = 21, 
           fill = c("white"), size = 7)+
  ...
  annotate("point", x = 4, y = c(1, 2, 3), shape = 21, , 
           fill = c("#0D088780", "#B12A9080", "#E1646280"), size = 7) +
  annotate("point", x = 5, y = c(1, 2, 3), shape = 21,, 
           fill = c("#0D088780", "#B12A9080", "#E1646280"), size = 7) +
  annotate("label", x = 3, y = 4.75, label = "Measured outcome Y", size = 5) +
  annotate("label", x = 3, y = -0.25, label = expression(Delta~"t"~"="~0),
           size = 7) +
  geom_curve(aes(x = 4.15, y = 3, xend = 4.85, yend = 3),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "black", linewidth = 0.5) +
  geom_curve(aes(x = 4.15, y = 2, xend = 4.85, yend = 2),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "black", linewidth = 0.5) +
  geom_curve(aes(x = 4.15, y = 1, xend = 4.85, yend = 1),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "black", linewidth = 0.5) 
```
