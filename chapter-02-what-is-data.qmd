...
ggplot() +
  ...
  annotate("text", x = 0.25, y = 4.25, label = "[i, ]", fontface = 2, size = 5) +
  annotate("text", x = 0.75, y = 4.75, label = "[ , j]", fontface = 2, size = 5) +
  annotate("text", x = 3.5, y = 4.75, label = "Columns", size = 10, fontface = 3) +
  annotate("text", x = 0.25, y = 2.5, label = "Rows", size = 10, fontface = 3, angle = 90)
