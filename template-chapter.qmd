...
##  coord_cartesian(xlim = c(0, 10), ylim = c(-20, 20)) +
  ...
  annotate("text", x = 11, y = 4.75, hjust = "left", 
           ...
           color = "black", size = 6) + 
  annotate("text", x = 14.5, y = 5.9, hjust = "center", 
           label = "16.08 cm", color = "#E16462FF", fontface = 1, size = 6) +
...
ggplot() +
  ...
  theme_minimal() +
  ## coord_cartesian(xlim = c(0, 10), ylim = c(-20, 20)) +
  scale_x_continuous(breaks = -15:15, expand = expansion(mult = 0), limits = c(-15, 15)) +
  annotate("segment", x = 0, xend = 0, y = 0, yend = -12, color = "black") 
```
