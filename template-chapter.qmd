...
cor_high_tbl |> 
  ...
  scale_y_continuous(breaks = c(8, 10, 12, 14, 16, 18, 20, 22, 24),
                     ...
                     limits = c(NA, NA)) +
  labs(x = str_pad("Cat flea weight [mg]", 140, "right"), y = "Jump length in [cm]") +
  scale_color_viridis(discrete = TRUE, option = "plasma", end = 0.9) +
  ## upper right
  ...
  annotate("text", x = 14.25, y = 23.25, label = expression(bold(SS[xy])), size = 4.5,
           hjust = "left") +
  geom_tile(aes(x = c(15.1, 19.5, 21, 21, 17.3), 
  ...
  annotate("text", x = 21.75, y = 16.75, label = expression(sum()*47.94), size = 4.5,
           hjust = "right") +
  annotate("text", x = 14.25, y = 19, label = expression(bold(SS[y])), size = 4.5,
           hjust = "left") +
  geom_tile(aes(x = c(23.5, 25.25, 26.75, 27.625, 29), 
                y = c(17.5, 18, 18, 18, 18.5), 
  ...
  annotate("text", x = 30, y = 16.75, label = expression(sum()*33.96), size = 4.5,
           hjust = "right") +
  annotate("text", x = 22.5, y = 19, label = expression(bold(SS[x])), size = 4.5,
           hjust = "left") +
  ## lower right left
  ...
  annotate("text", x = 14.6, y = 10.25, hjust = "center", label = "6.92", color = "#0D0887FF",
  ...
  annotate("segment", x = 23.4, xend = 23.4, 
           y = 8.85, yend = 11.625, size = 1.5, color = "#B12A90FF") +
  annotate("text", x = 23.8, y = 10.2375, hjust = "center", label = "5.83", color = "#B12A90FF",
           fontface = 2, angle = -90, size = 3.5) +
