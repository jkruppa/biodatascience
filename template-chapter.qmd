...
ggplot() +
  theme_void() +
  theme_minimal() +
  coord_cartesian(xlim = c(0.5, 7.5), ylim = c(-5, 5)) +
  ...
  annotate("text", x = 1:7, y = -1, label = 1:7) +
  annotate("point", x = 4, y = -5, shape = 13, size = 5) +
  annotate("segment", x = 4, xend = 6, y = -5, yend = 0.5, linetype = 2) +
  annotate("segment", x = 4, xend = 2, y = -5, yend = 0.5, linetype = 2)
