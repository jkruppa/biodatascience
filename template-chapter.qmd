...
geom_spit_tile <- function(x, y, a, b, weight, color, fill) {
  ...
  list(  
    geom_shape(data = tibble(x = c(x, x+b-0.01, x), 
                             y = c(y+0.01, y+a, y+a)),
               aes(x, y), color = color[1], fill = fill[1]),
    geom_shape(data = tibble(x = c(x+0.01, x+b, x+b), 
                             y = c(y, y, y+a-0.01)),
               aes(x, y), color = color[2], fill = fill[2])    
  ) 
}
...
cor_high_tbl |> 
  ...
  geom_spit_tile(x = c(16.5), y = c(21.75), 
                 ...
                 color = c("#0D0887FF", "#B12A90FF"), fill = c("#0D088780", "#B12A9080")) +
  geom_spit_tile(x = c(23.5), y = c(20.5), 
                 a = cor_high_tbl$sweight[3], b = cor_high_tbl$sjump[3], weight = 1,
                 color = c("#0D0887FF", "#B12A90FF"), fill = c("#0D088780", "#B12A9080")) +
  geom_spit_tile(x = c(24.5), y = c(21), 
                 b = cor_high_tbl$sweight[4], a = cor_high_tbl$sjump[4], weight = 1,
                 color = c("#0D0887FF", "#B12A90FF"), fill = c("#0D088780", "#B12A9080")) +
  geom_spit_tile(x = c(26), y = c(22.25), 
                 a = cor_high_tbl$sweight[5], b = cor_high_tbl$sjump[5], weight = 0.7,
                 color = c("#0D0887FF", "#B12A90FF"), fill = c("#0D088780", "#B12A9080")) +
  geom_tile(aes(x = c(15, 16, 17, 18, 19), 
                y = c(18, 18, 18, 18, 18), 
                width = sjump/2, height = sjump/2), fill = "#0D088780",
            alpha = 0.2, color = "#0D0887FF", linewidth = 0.5) + 
  geom_tile(aes(x = c(23, 24, 25, 26, 27), 
                y = c(18, 18, 18, 18, 18), 
