...
ggplot() +
  ...
  annotate("point", x = c(0.5, 1, 1.25, 1.7, 2.5, 3.2) + 3.5, 
           y = c(20.5, 21, 21.5, 22, 22.5, 22)) +
  annotate("segment", x = 3.75, xend = 7.25, y = 20.5, yend = 23, linewidth = 0.65) +
  geom_curve(aes(x = 4, y = 20, xend = 7.25, yend = 21.5),
  ...
  annotate("point", x = c(12.5), 
           y = c(20.75, 21.25, 21.5, 22.2, 22.5)) +
  ...
  ### 2lvl
  geom_rect(aes(xmin = 16.1, xmax = 16.35, ymin = 19.5, ymax = 22.25), fill = "#B12A9080",
            color = "black") +
  geom_segment(aes(x = 16.225, xend = 16.225, y = 22.25, yend = 22.75)) +
  geom_segment(aes(x = 16.15, xend = 16.3, y = 22.75, yend = 22.75)) +  
  annotate("point", x = c(16.75), 
           y = c(21.5, 22, 22.5, 22.75, 23)) +  
  geom_rect(aes(xmin = 16.65, xmax = 16.9, ymin = 21.5, ymax = 23), fill = "#FCA63680",
            color = "black") +
  geom_segment(aes(x = 16.65, xend = 16.9, y = 22.5, yend = 22.5)) +
  geom_segment(aes(x = 16.775, xend = 16.775, y = c(21.1, 23), yend = c(21.5, 23.25))) +
  geom_rect(aes(xmin = 18.1, xmax = 18.35, ymin = 19.5, ymax = 20.5), fill = "#B12A9080",
            color = "black") +
  geom_segment(aes(x = 18.225, xend = 18.225, y = 20.5, yend = 21)) +
  geom_segment(aes(x = 18.15, xend = 18.3, y = 21, yend = 21)) +  
  annotate("point", x = c(18.25), 
           y = c(19.75, 20, 20.5, 21, 21.25)) +  
  geom_rect(aes(xmin = 18.65, xmax = 18.9, ymin = 20, ymax = 21), fill = "#FCA63680",
            color = "black") +
  geom_segment(aes(x = 18.65, xend = 18.9, y = 20.5, yend = 20.5)) +
  geom_segment(aes(x = 18.775, xend = 18.775, y = c(19.7, 21), yend = c(20, 21.3))) +  
  annotate("point", x = c(16.75), 
           y = c(21.5, 22, 22.5, 22.75, 23)) +  
  annotate("point", x = c(18.25), 
           y = c(19.75, 20, 20.5, 21, 21.25))
