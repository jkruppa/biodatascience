...
p_bio_rep <- ggplot() +
  ...
  annotate("text", x = c(-7, -7, -7),
           y = c(8, 0, -8)-2.5, fontface = 2, size = 4.5, color = "gray50",
           label = c("Chris", "Charles", "Cameron")) +
  annotate("point", c(-7, -7, -7), y = c(8, 0, -8)+0.75, color = "#FDC926FF", size = 2) +
  geom_ellipse(aes(x0 = 2.5, y0 = 7.75, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = 8.75, xend = 2.5, yend = 8),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.2, color = "#FDC926FF", linewidth = 0.75, linetype = 1) +
  geom_ellipse(aes(x0 = 5, y0 = -0.25, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = 0.75, xend = 5, yend = 0),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.2, color = "#FDC926FF", linewidth = 0.75, linetype = 1) +
  geom_ellipse(aes(x0 = 3.75, y0 = -8.25, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = -7.25, xend = 3.75, yend = -8),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.2, color = "#FDC926FF", linewidth = 0.75, linetype = 1) +  
  labs(title = "Biological replication") +
  theme(plot.title = element_text(size = 16, face = "bold"),
        plot.subtitle = element_text(size = 12, face = "italic"))
...
p_tech_rep <- ggplot() +
  ...
  annotate("text", x = -7, y = -2.5, fontface = 2, size = 4.5, color = "gray50",
           label = "Charles") +
  annotate("point", -7, y = 0.75, color = "#FDC926FF", size = 2) +
  geom_ellipse(aes(x0 = 4.75, y0 = 7.75-4, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = 0.75, xend = 4.75, yend = 4),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "#FDC926FF", linewidth = 0.75, linetype = 1) +
  geom_ellipse(aes(x0 = 5, y0 = -0.25, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = 0.75, xend = 5, yend = 0),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "#FDC926FF", linewidth = 0.75, linetype = 1) +
  geom_ellipse(aes(x0 = 4.5, y0 = -8.25+4, a = 0.5, b = 0.25, angle = 0), 
               color = "gray20", fill = "#FDC92680") +
  geom_curve(aes(x = -7, y = 0.75, xend = 4.5, yend = -4),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "#FDC926FF", linewidth = 0.75, linetype = 1) + 
  labs(title = "Technical replication") +
  theme(plot.title = element_text(size = 16, face = "bold"),
        plot.subtitle = element_text(size = 12, face = "italic"))
...
p_lab_rep <- ggplot() +
  ...
  annotate("segment", x = -4, y = -2, xend = -4, yend = 2, lineend = "round", size = 5,
           color = "gray25") +
  geom_ellipse(aes(x0 = -4, y0 = 2.3, a = 0.425, b = 0.25, angle = 0), 
               color = "gray25", fill = "#E16462FF") +
  labs(title = "Cell culture replication") +
  theme(plot.title = element_text(size = 16, face = "bold"),
        plot.subtitle = element_text(size = 12, face = "italic"))
