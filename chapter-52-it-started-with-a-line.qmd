...
#| fig-height: 3.5
#| fig-width: 7
#| fig-cap: "Visualisation of the calculation of the sum of squares. **(A)** The area of each square is determined. **(B)** All the areas are then combined to form one large square. The square root can then be used for further statistical analysis."
