...
ggplot() +
  ...
  annotate("text", x = c(1.5, 2, 3, 4.5)+0.1, 
  ...
  annotate("text", x = 2.75, y = 3.6, color = "#B12A90FF",
...
ggplot() +
  ...
  annotate("point", x = c(1.5, 2, 3, 4.5), y = c(2, 3.5, 4, 3.5)) +
  ## parameters
  annotate("point", x = 0.5, y = 1, color = "red", size = 3) +
  annotate("segment", x = 0.75, y = 2.15, xend = 1.75, yend = 3.15,
           color = "green", size = 1) +
  annotate("point", x = 1.25, y = 2.65, color = "green") +
  annotate("segment", x = 2.25, y = 3.4, xend = 3.25, yend = 3.6,
           color = "green", size = 1) +
  annotate("point", x = 2.75, y = 3.5, color = "green") +
  annotate("segment", x = 3.75, y = 3.575, xend = 4.75, yend = 3.175,
           color = "green", size = 1) +
  annotate("point", x = 4.25, y = 3.38, color = "green") +
#  annotate("segment", x = c(1.5, 2, 3, 4.5), y = c(2, 3.5, 4, 3.5), 
#           xend = c(1.5, 2, 3, 4.5), yend = 2 + (c(1.5, 2, 3, 4.5)-0.5) * 0.55,
