...
p1 <- ggplot() +
 ...
 ## theme_minimal() +
  ...
  annotate("text", x = c(1.5, 2, 3, 4.5)+0.2, 
           y = (c(2, 3.5, 4, 3.5) + (2 + (c(1.5, 2, 3, 4.5)-0.5) * 0.55))/2, size = 5,
  ...
  annotate("text", x = 0.3, y = 2, color = "#0D0887FF", size = 5,
...
coord_equal() +
 ## theme_minimal() +
  ...
  annotate("text", x = 0.3, y = 1, color = "#0D0887FF", size = 5,
           label = expression(beta[0]))  +
