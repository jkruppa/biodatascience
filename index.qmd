...
Ultimately, I wanted to write a book with a moderate Hawking Index that people would read from cover to cover. The Hawking index is a mathematical measure based on Kindle reader highlights and therefore on how far people will, on average, read a book before giving up.

Machine room of science

Bloody beginners and the curse of knowledge

Which book should I read if I want to experience the feeling of watching the History Channel? Joachim Krauth's book, *Experimental Design: A Handbook and Dictionary for Medical and Behavioural Research*, is a good starting point @krauth2000experimental.

This book was written using KI to avoid French and Latin words that nobody understands or can pronounce. We use plain and simple English words.

:::callout-note
## Noteworthy statements

- Science is an iterative process.
- Science makes model-based decisions based on data.
- Data are observations expressed as numbers.
- Decisions are, by their very nature, undecidable; otherwise, they would be computable.
- There are digital and analog tools that require skills to use them, as well as knowledge to evaluate the results.
- Rule-based decisions differ from human decisions. Computers make rule-based decisions. Rule-based decisions are objective.
- In statistical data analysis, we can examine correlations or make predictions.
:::
