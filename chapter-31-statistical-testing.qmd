...
#             aes(x, y), radius = unit(0.5, 'cm'), fill = "gray95") +
  ...
  annotate("text", x = 10.25, y = 5, label = "SAMPLE", size = 6, fontface = 2, 
           angle = -90) +
  ...
  geom_curve(aes(x = -1, y = 6.5, xend = 1.9, yend = 6.5),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = -0.3, color = "black", linewidth = 0.5) +
  geom_circle(aes(x0 = 3, y0 = 4, r = 1), fill = "white") +
  annotate("text", x = 3, y = 4, label = expression(R[3]), size = 6) +
  geom_curve(aes(x = -1, y = 3.5, xend = 1.9, yend = 3.5),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = 0.3, color = "black", linewidth = 0.5) +
  geom_circle(aes(x0 = 3, y0 = 1.5, r = 1), fill = "white") +
  annotate("text", x = 3, y = 1.5, label = expression(R[k]), size = 6) +
  geom_curve(aes(x = -1.9, y = 2, xend = 1.9, yend = 1.5),
             arrow = arrow(length = unit(0.02, "npc"), type = "closed"),
             curvature = 0.3, color = "black", linewidth = 0.5) 
```
